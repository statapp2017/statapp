...
#' @return A list which contains the probability of each observation of \code{new_verbatim} to 
...
analyse_new_verbatim <- function(new_verbatim) {
  ...
  posterior_distribution <- posterior(model_theme$models, newdata = result_preprocess$dtm)
